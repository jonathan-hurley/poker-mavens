...
# site stats
TOTAL_PLAYER_HANDS=`ggrep -E -he 'Seat.*\[(\w| )+]' $GREP_FILE_PATTERN_ALL | wc -l | sed -e 's/^[[:space:]]*//'`
...
TABLE_HANDS_CASH=`ggrep -E -he 'Hand #' $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
TABLE_HANDS_CASH=$(incrementSitePropertyInDB "table_hands_cash" $TABLE_HANDS_CASH)
TABLE_HANDS_TOURNAMENT=`ggrep -E -he 'Hand #' $GREP_FILE_PATTERN_TOURNAMENT | wc -l | sed -e 's/^[[:space:]]*//'`
TABLE_HANDS_TOURNAMENT=$(incrementSitePropertyInDB "table_hands_tournament" $TABLE_HANDS_TOURNAMENT)
FLOPS_SEEN=`ggrep -E -he '\*\* Flop \*\*' $GREP_FILE_PATTERN_ALL | wc -l | sed -e 's/^[[:space:]]*//'`
FLOPS_SEEN=$(incrementSitePropertyInDB "flops_seen" $FLOPS_SEEN)
FLOPS_WITH_SAME_SUIT=`ggrep -E -he '\*\* Flop \*\* (?:\[\ws \ws \ws\]|\[\wh \wh \wh\]|\[\wc \wc \wc\]|\[\wd \wd \wd\])' $GREP_FILE_PATTERN_ALL | wc -l`
FLOPS_WITH_SAME_SUIT=$(incrementSitePropertyInDB "suited_flops" $FLOPS_WITH_SAME_SUIT)
POCKET_AA=`ggrep -E -he 'Seat.*\[A\w A\w\]' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
...
HAND_ENDS_FLOP_TOURNAMENT=`ggrep -E -he 'End: Flop' $GREP_FILE_PATTERN_TOURNAMENT | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_FLOP_TOURNAMENT=$(incrementSitePropertyInDB "hand_ends_flop_tournament" $HAND_ENDS_FLOP_TOURNAMENT)
HAND_ENDS_TURN_TOURNAMENT=`ggrep -E -he 'End: Turn' $GREP_FILE_PATTERN_TOURNAMENT | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_TURN_TOURNAMENT=$(incrementSitePropertyInDB "hand_ends_turn_tournament" $HAND_ENDS_TURN_TOURNAMENT)
HAND_ENDS_RIVER_TOURNAMENT=`ggrep -E -he 'End: River' $GREP_FILE_PATTERN_TOURNAMENT | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_RIVER_TOURNAMENT=$(incrementSitePropertyInDB "hand_ends_river_tournament" $HAND_ENDS_RIVER_TOURNAMENT)
HAND_ENDS_SHOWDOWN_TOURNAMENT=`ggrep -E -he 'End: Showdown' $GREP_FILE_PATTERN_TOURNAMENT | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_SHOWDOWN_TOURNAMENT=$(incrementSitePropertyInDB "hand_ends_showdown_tournament" $HAND_ENDS_SHOWDOWN_TOURNAMENT)
HAND_ENDS_PREFLOP_CASH=`ggrep -E -he 'End: PreFlop' $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_PREFLOP_CASH=$(incrementSitePropertyInDB "hand_ends_preflop_cash" $HAND_ENDS_PREFLOP_CASH)
HAND_ENDS_FLOP_CASH=`ggrep -E -he 'End: Flop' $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_FLOP_CASH=$(incrementSitePropertyInDB "hand_ends_flop_cash" $HAND_ENDS_FLOP_CASH)
HAND_ENDS_TURN_CASH=`ggrep -E -he 'End: Turn' $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_TURN_CASH=$(incrementSitePropertyInDB "hand_ends_turn_cash" $HAND_ENDS_TURN_CASH)
HAND_ENDS_RIVER_CASH=`ggrep -E -he 'End: River' $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_RIVER_CASH=$(incrementSitePropertyInDB "hand_ends_river_cash" $HAND_ENDS_RIVER_CASH)
HAND_ENDS_SHOWDOWN_CASH=`ggrep -E -he 'End: Showdown' $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
HAND_ENDS_SHOWDOWN_CASH=$(incrementSitePropertyInDB "hand_ends_showdown_cash" $HAND_ENDS_SHOWDOWN_CASH)

# game hands (holdem)
ROYAL_FLUSHES=`ggrep -E -he '.*shows.*Royal' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
ROYAL_FLUSHES=$(incrementGameHandInDB "holdem" "royal_flush" $ROYAL_FLUSHES)
STRAIGHT_FLUSH=`ggrep -E -he '.*shows.*Straight Flush' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
STRAIGHT_FLUSH=$(incrementGameHandInDB "holdem" "straight_flush" $STRAIGHT_FLUSH)
QUADS=`ggrep -E -he '.*shows.*Four of a Kind' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
QUADS=$(incrementGameHandInDB "holdem" "four_of_a_kind" $QUADS)
FULL_HOUSE=`ggrep -E -he '.*shows.*Full House' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
FULL_HOUSE=$(incrementGameHandInDB "holdem" "full_house" $FULL_HOUSE)
FLUSH=`ggrep -E -he '.*shows.*Flush' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
FLUSH=$(incrementGameHandInDB "holdem" "flush" $FLUSH)
STRAIGHT=`ggrep -E -he '.*shows.*Straight' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
STRAIGHT=$(incrementGameHandInDB "holdem" "straight" $STRAIGHT)
THREE_KIND=`ggrep -E -he '.*shows.*Three of a Kind' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
THREE_KIND=$(incrementGameHandInDB "holdem" "three_of_a_kind" $THREE_KIND)
TWO_PAIR=`ggrep -E -he '.*shows.*Two Pair' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
TWO_PAIR=$(incrementGameHandInDB "holdem" "two_pair" $TWO_PAIR)
PAIR=`ggrep -E -he '.*shows.*a Pair' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
PAIR=$(incrementGameHandInDB "holdem" "pair" $PAIR)
HIGH_CARD=`ggrep -E -he '.*shows.*High Card' $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
HIGH_CARD=$(incrementGameHandInDB "holdem" "high_card" $HIGH_CARD)

# game hands (omaha)
ROYAL_FLUSHES_OMAHA=`ggrep -E -he '.*shows.*Royal' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
ROYAL_FLUSHES_OMAHA=$(incrementGameHandInDB "omaha" "royal_flush" $ROYAL_FLUSHES_OMAHA)
STRAIGHT_FLUSH_OMAHA=`ggrep -E -he '.*shows.*Straight Flush' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
STRAIGHT_FLUSH_OMAHA=$(incrementGameHandInDB "omaha" "straight_flush" $STRAIGHT_FLUSH_OMAHA)
QUADS_OMAHA=`ggrep -E -he '.*shows.*Four of a Kind' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
QUADS_OMAHA=$(incrementGameHandInDB "omaha" "four_of_a_kind" $QUADS_OMAHA)
FULL_HOUSE_OMAHA=`ggrep -E -he '.*shows.*Full House' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
FULL_HOUSE_OMAHA=$(incrementGameHandInDB "omaha" "full_house" $FULL_HOUSE_OMAHA)
FLUSH_OMAHA=`ggrep -E -he '.*shows.*Flush' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
FLUSH_OMAHA=$(incrementGameHandInDB "omaha" "flush" $FLUSH_OMAHA)
STRAIGHT_OMAHA=`ggrep -E -he '.*shows.*Straight' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
STRAIGHT_OMAHA=$(incrementGameHandInDB "omaha" "straight" $STRAIGHT_OMAHA)
THREE_KIND_OMAHA=`ggrep -E -he '.*shows.*Three of a Kind' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
THREE_KIND_OMAHA=$(incrementGameHandInDB "omaha" "three_of_a_kind" $THREE_KIND_OMAHA)
TWO_PAIR_OMAHA=`ggrep -E -he '.*shows.*Two Pair' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
TWO_PAIR_OMAHA=$(incrementGameHandInDB "omaha" "two_pair" $TWO_PAIR_OMAHA)
PAIR_OMAHA=`ggrep -E -he '.*shows.*a Pair' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
PAIR_OMAHA=$(incrementGameHandInDB "omaha" "pair" $PAIR_OMAHA)
HIGH_CARD_OMAHA=`ggrep -E -he '.*shows.*High Card' $GREP_FILE_PATTERN_OMAHA | wc -l | sed -e 's/^[[:space:]]*//'`
...
do
  ...
  POCKET_PAIR=`ggrep -E -he "Seat.*\[$CARD\w $CARD\w\]" $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
  POCKET_PAIR=$(incrementPocketPairStatInDB "$CARD$CARD" "total" $POCKET_PAIR)
  POCKET_PAIR_HANDS_WON=`ggrep -E -h "^.* \(\+.*\) (\[$CARD\w $CARD\w\])" $GREP_FILE_PATTERN_HOLDEM | wc -l | sed -e 's/^[[:space:]]*//'`
...
for i in "${!PLAYERS[@]}"; do
  ...
  PLAYER_TOTAL_HANDS_DEALT=`ggrep -E -he "Seat [0-9]+: $PLAYER \(.*\) \[.*\]" $GREP_FILE_PATTERN_ALL | wc -l | sed -e 's/^[[:space:]]*//'`
  ...
  PLAYER_FOLDED_HANDS_TOURNAMENT=`ggrep -E -he "^$PLAYER folds" $GREP_FILE_PATTERN_TOURNAMENT | wc -l | sed -e 's/^[[:space:]]*//'`
  PLAYER_FOLDED_HANDS_TOURNAMENT=$(incrementPlayerStatInDB "$PLAYER" "folded_hands_tournament" $PLAYER_FOLDED_HANDS_TOURNAMENT)
  PLAYER_SHOWN_HANDS_TOURNAMENT=`ggrep -E -he "^$PLAYER shows" $GREP_FILE_PATTERN_TOURNAMENT | wc -l | sed -e 's/^[[:space:]]*//'`
  PLAYER_SHOWN_HANDS_TOURNAMENT=$(incrementPlayerStatInDB "$PLAYER" "shown_hands_tournament" $PLAYER_SHOWN_HANDS_TOURNAMENT)
  PLAYER_REFUNDED_HANDS_TOURNAMENT=`ggrep -E -he "^$PLAYER refunded" $GREP_FILE_PATTERN_TOURNAMENT | wc -l | sed -e 's/^[[:space:]]*//'`
  ...
  PLAYER_NUMBER_OF_TOURNAMENTS=`ggrep -E -he "=$PLAYER " $GREP_FILE_PATTERN_TOURNAMENT_RESULTS | wc -l | sed -e 's/^[[:space:]]*//'`
  PLAYER_NUMBER_OF_TOURNAMENTS=$(incrementPlayerStatInDB "$PLAYER" "tournaments_entered" $PLAYER_NUMBER_OF_TOURNAMENTS)

  # player cash stats
  PLAYER_FOLDED_HANDS_CASH=`ggrep -E -he "^$PLAYER folds" $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
  PLAYER_FOLDED_HANDS_CASH=$(incrementPlayerStatInDB "$PLAYER" "folded_hands_cash" $PLAYER_FOLDED_HANDS_CASH)
  PLAYER_SHOWN_HANDS_CASH=`ggrep -E -he "^$PLAYER shows" $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
  PLAYER_SHOWN_HANDS_CASH=$(incrementPlayerStatInDB "$PLAYER" "shown_hands_cash" $PLAYER_SHOWN_HANDS_CASH)
  PLAYER_REFUNDED_HANDS_CASH=`ggrep -E -he "^$PLAYER refunded" $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
  PLAYER_REFUNDED_HANDS_CASH=$(incrementPlayerStatInDB "$PLAYER" "refunded_hands_cash" $PLAYER_REFUNDED_HANDS_CASH)    
  PLAYER_WON_HANDS_CASH=`ggrep -E -he "^$PLAYER wins (Side Pot [0-9]|Main Pot|Pot) \(.*\)" $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
  PLAYER_WON_HANDS_CASH=$(incrementPlayerStatInDB "$PLAYER" "won_hands_cash" $PLAYER_WON_HANDS_CASH)

  PLAYER_TOTAL_WON_POT_SIZE_CASH=`ggrep -E -he "^$PLAYER wins (Side Pot [0-9]|Main Pot|Pot) \(.*\)" $GREP_FILE_PATTERN_CASH | ggrep -E -o "\(.*\)" | ggrep -E -oe '\([0-9]{1,}\.?.*\)' | tr -d '()' | awk '{s+=$1} END {print s}'`
  ...
  PLAYER_ALL_INS_CASH=`ggrep -E -he "^$PLAYER .*\(All-in\)" $GREP_FILE_PATTERN_CASH | wc -l | sed -e 's/^[[:space:]]*//'`
  ...
  PLAYER_BIGGEST_CASH_HAND=`ggrep -E -ho "^$PLAYER wins (Side Pot [0-9]|Main Pot|Pot) \(.*\)" $GREP_FILE_PATTERN_CASH | ggrep -E -o "\(.*\)" | ggrep -E -o "[0-9,.]+" | sort -n | tail -n 1`
  ...
  do
    ...
    do
      PLAYER_HOLE_CARD_COUNT=`ggrep -E -oh "Seat [0-9]+: $PLAYER \(.*\) (\[$FIRST_CARD\w $SECOND_CARD\w\])" $GREP_FILE_PATTERN_ALL | wc -l | sed -e 's/^[[:space:]]*//'`
